...
for i in range(0,data3.shape[0]):
    ...
    if temp_text=='':
        ...
        ar_name_final = data3['ar_name'][i]+' ('+data3['taqbilt'][i]+')'
        text_adwwar=text1.replace('shi_name',data3['shi_name'][i]).replace('ar_name',ar_name_final).replace('nb_fam',str(data3['nb_fam'][i])).replace('nb_hab',str(data3['nb_hab'][i])).replace('shi_taqbilt',data3['shi_taqbilt'][i]).replace('shi_tagrawt',data3['shi_tagrawt'][i])
        ...
        temp_text = temp_text + text3.replace('shi_taqbilt',data3['shi_taqbilt'][i]).replace('shi_tagrawt',data3['shi_tagrawt'][i])
